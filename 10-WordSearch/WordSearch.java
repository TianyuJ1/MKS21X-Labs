  ...
  private void addAllWords(String filename){
    ...
    //You are writing this
        for (int i = 0; i < 100; i++){
          ...
          int StringPosition = rng.nextInt(wordsToAdd.size());
          int startingY = rng.nextInt(grid.length);
          int startingX = rng.nextInt(grid[0].length);
          int ydirection = rng.nextInt(3) -1;
          int xdirection = rng.nextInt(3) -1;
          addWord(wordsToAdd.get(StringPosition));
        }
